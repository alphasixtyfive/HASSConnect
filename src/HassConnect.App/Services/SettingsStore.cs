...
internal sealed class SettingsStore
{
    ...
    public Settings LoadSettings()
    {
        ...
        if (settings.EnabledPcCommands is null || settings.EnabledSensors is null || settings.CustomCommands is null)
    ...
    public void Save(Settings settings) => WriteAtomic("settings.json", JsonSerializer.SerializeToUtf8Bytes(settings, Json));
